...
def Plot_HeatMap_PATHS_IMC(df_allinfo_GSE1,dict_path_gens,factorAug=2.0,titulo='',typeFig='',nom_figure='figure.png'):
    """Bar plot dels PATHS, respecte a col prediction"""
    if typeFig=='Llarga1':
        figure(figsize=(4, 12), dpi=300)
    else:
        plt.suptitle(titulo) 
